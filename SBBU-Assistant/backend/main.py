...
from database.chroma_utils import index_document_to_chroma, delete_doc_from_chroma
from database.db_utils import insert_chat_history, get_chat_history, get_all_documents, insert_document_record, delete_document_record
...
def chat(query_input: QueryInput):
    ...
    try:
        ...
        messages = append_message(messages, HumanMessage(content=query_input.question))
