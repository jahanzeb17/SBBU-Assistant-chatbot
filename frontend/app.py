from chat_interface import display_voice_chat_interface, display_Text_chat_interface
import streamlit as st
from api_utils import upload_document, list_documents, delete_document


st.set_page_config(
    page_title="Voice Agentic RAG System",
    page_icon="🤖",
    layout="wide")

st.header("SBBU Assistant Chatbot", divider="red")


# st.title("Voice Agentic RAG System")

option = st.sidebar.selectbox("Select Text or Voice", options=["Voice", "Text"])
...
if option == "Voice":
    display_voice_chat_interface()
else:
    display_Text_chat_interface()